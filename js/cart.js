...
const subTotal = document.querySelector(".s-cart .s_right .s_topCart .s_textTotal .s_number span");
const total = document.querySelector(".s-cart .s_right .s_botCart h5 span");
...
function showCart() {
    ...
    <div class="s_rightChild">
        ...
        <div class="s_content">
        <p class="s_inforPro"><span>Size: </span>${element.choice.size}</p>
        </div>
        <div class="s_quality">
